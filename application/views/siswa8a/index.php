<div class="container">
    <h2 class="text-center mt-5">Data Siswa 8-A</h2>
    <div class="col text-center">
            <a class="btn btn-outline-secondary" href="<?= base_url(); ?>siswa8a/chart" role="button">Chart</a>
            <a class="btn btn-outline-danger" href="<?= base_url(); ?>siswa8a/export_pdf" role="button">Export to PDF</a>
            <a class="btn btn-outline-success" href="<?= base_url(); ?>siswa8a/export_excel" role="button">Export to Excel</a>
    </div>
...
$(document).ready(function(){
  ...
  {
    $.ajax({
      url:"<?php echo base_url(); ?>siswa8a/load_data",
      dataType:"JSON",
      success:function(data){
        var html = '<tr>';
        html += '<td id="nisn" contenteditable placeholder="Masukkan NISN"></td>';
        html += '<td id="id_kelas" value="KLS0081">KLS0081</td>';
  ...
  $(document).on('click', '#btn_add', function(){
    ...
    $.ajax({
      url:"<?php echo base_url(); ?>siswa8a/insert",
      method:"POST",
  ...
  $(document).on('blur', '.table_data', function(){
    ...
    var value = $(this).text();
    $.ajax({
      url:"<?php echo base_url(); ?>siswa8a/update",
      method:"POST",
  ...
  $(document).on('click', '.btn_delete', function(){
    ...
    {
      $.ajax({
        url:"<?php echo base_url(); ?>siswa8a/delete",
        method:"POST",
        data:{nisn:nisn},
        success:function(data){
          load_data();
